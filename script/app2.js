...
let boutonmusique = document.getElementById("sound")

const music = new Audio('../img/samba.wav');
...
boutonmusique.addEventListener("click", function() {
    ...
    if(bouleen) {
        ...
        boutonmusique.style.display = 'none' 
        boutonmusique.style.position = 'absolute';
        boutonmusique.style.right = z + "px";
        boutonmusique.style.top = r + "px";
        
        setInterval(() => {
        boutonmusique.style.display = 'block' 
        }, 10000);
